...
DATA_FILE = BASE_DIR / "dataset" / "skin_health_train.csv"

MODEL_FILE = BASE_DIR / "model.joblib"
ENCODERS_FILE = BASE_DIR / "encoders.joblib"

RANDOM_SEED = 42

ORDINAL_COLS = [
    'sugar_intake', 'dairy_intake', 'processed_food_freq',
...
def train():
    ...
    print("Saved encoders:", ENCODERS_FILE)
